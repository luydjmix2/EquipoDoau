...
<body>
    ...
    <section>
        <div>
            <span class="location-text location-text-address">Dirección de entrega</span>
            <form action="" method="POST" >
                ...
                <button onclick="" type="button" >Buscar</button>
            </form>
        </div>
    </section>
    <section>
    ...
    <footer class="content_module new_row new_footer show">
        <section class="new_center_content" >
            <div class="row content_social_apps"> 
                ...
                <ul class="content_links">
                    ...
                    <li><button id="suggestRestoBtn" class="button suggest" rel="nofollow">Registra tu negocio</button></li>   
                </ul>   
               <!--Social-->
                ...
                <!--Apps-->
                 <ul class="content_apps">                      <li class="title">Descargar app</li>
                    <li class="ic_android">           <a href="https://play.google.com/store&amp;referrer=none" target="_blank" class="android" title="Android">Android</a>
                     </li>
                </ul>
            </div>
            <hr class="divider">
